...
- A narrow NTU Red rail fixes the left edge, while a deep NTU Blue footer labelled `EE6008 · Instance-Preserving Pose Representation` creates a consistent presentation frame with the page number on the right.
...
- Campus photography defines the cover and closing compositions and supplies replaceable preview imagery for the image-story layouts. The cover follows the confirmed Week 3 visual: a full-bleed exterior view of The Hive with layered NTU Blue-to-Red gradients, the course and presentation label at upper-left, the NTU logo at upper-right, and editable week/date badges. The closing page uses a white-washed full-background photograph of the NTU EEE S2 building with dark-blue central typography.
...
|---|---|---|---|
| `01_cover.svg` | `weekly-cover` | `Weekly Update — Cover` | Week 3-derived full-bleed exterior view of The Hive with an editable blue-to-red gradient image module, course/presentation label, NTU logo, two-line Human Pose Analytics title, Instance-Preserving Pose Representation subtitle, Week/Group badges, and an editable week-ending date. |
...
| `images/the_hive_week3_cover.png` | 1280 × 1059 | Presentation-optimized derivative of the 907 × 751 The Hive image extracted from the user-provided `Week3_G14.pptx`; used by the Week 3-derived full-bleed cover module. |
